...
<div class="row p-0">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                <div class="col-md"><h4 class="text-primary">Identification</h4></div>
                <!-- <div class="col-md"><button class="btn btn-outline-warning mb-2">Clear record</button></div> -->
                <div class="col-md"><button class="btn btn-outline-primary mb-2 float-end" @click="classify">Compare</button></div>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered" id="myTable">
                    ...
                    <td> {{d['dataid']}} </td>
                    <td> {{d['Category']}} </td>
                    <td> <img src="@/assets/icons/fingericon.png" alt="" width="50"> </td>
                    <td> {{d['prediction']}} </td>
                    <td> {{d['t1']}} </td>
                       </tr>
...
export default {
 ...
 preview: function(){
        ...
        this.isDisabled = true
        this.opacity = this.opacity_enable
        axios.get(process.env.VUE_APP_API+'/api/list/preview/',{
              params:{
                userid: this.usersession['email_one'],
            }
        })
