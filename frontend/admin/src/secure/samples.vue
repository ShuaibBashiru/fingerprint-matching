...
<div class="row p-0">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                <div class="col-md"><h4 class="text-primary">Collected Samples</h4></div>
...
export default {
 ...
 classify: function(){
        ...
        axios.get(process.env.VUE_APP_API+'/api/list/classify/',{
              params:{
 ...
 preview: function(){
    ...
    preview2: function(){
        ...
        this.isDisabled = true
        this.opacity = this.opacity_enable
        axios.get(process.env.VUE_APP_API+'/api/list/preview2/',{
              params:{
                userid: this.usersession['email_one'],
            }
        })
