...
<ul class="navbar-nav m-0 p-0 ms-auto">
        ...
        <li class="mb-2">
        <p class="pb-0 mb-1 align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#menu" aria-expanded="false">
        <i class="bi-list me-1"></i>    Menus
...
export default {
        ...
        chats: [
            {"menuName":'dashboard', 'menu_description':'Dashboard'},
            {"menuName":'samples', 'menu_description':'Evaluation'},
            {"menuName":'classify', 'menu_description':'Check identical'},
            {"menuName":'enrolfinger', 'menu_description':'Enrol fingers'},
